...
class RSIDNP(Base, DandelionBase):
    __tablename__ = "rsi_dnp"
    ...
    def to_all_dict(self):
        return dict(
            ...
            pathGuidance=self.path_guidance,
            info=self.info,
