...
from dandelion.mqtt.topic import server

LOG: LoggerAdapter = log.getLogger(__name__)
CONF: cfg = conf.CONF

topic_router: Dict[str, RouterHandler] = {
    server.V2X_RSU_INFO_UP: RSUInfoRouterHandler(),
    server.V2X_RSU_HB_UP: RSUHeartbeatRouterHandler(),
    server.V2X_RSU_BaseINFO_UP: RSUBaseINFORouterHandler(),
    server.V2X_RSU_RunningInfo_UP: RSURunningInfoRouterHandler(),
    server.V2X_RSU_INFOQuery_Response: RSUQueryUPRouterHandler(),
    server.V2X_RSU_MAP_DOWN_ACK: MapDownACKRouterHandler(),
    server.V2X_RSU_CONFIG_DOWN_ACK: RSUConfigDownACKRouterHandler(),
    server.V2X_RSU_MAP_UP: MapRouterHandler(),
    server.V2X_RSU_RSM_DOWN: RSMRouterHandler(),
    server.V2X_RSU_RSI_DOWN: RSIRouterHandler(),
    server.V2X_RSU_DNP_DOWN: RSIDNPRouterHandler(),
    server.V2X_RSU_CWM_DOWN: RSICWMRouterHandler(),
    server.V2X_RSU_CLC_DOWN: RSICLCRouterHandler(),
    server.V2X_RSU_SDS_DOWN: RSISDSRouterHandler(),
}
