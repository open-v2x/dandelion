...
def create(
    ...
    *,
    ...
    map_in_db = deps.crud_get(obj_id=map_id, crud_model=crud.map, detail="Map [id: {}] not found")
...
def delete(
    ...
    *,
    ...
    deps.crud_get(obj_id=map_id, crud_model=crud.map, detail="Map [id: {}] not found")
    deps.crud_get(obj_id=map_rsu_id, crud_model=crud.map_rsu, detail="MapRSU [id: {}] not found")
