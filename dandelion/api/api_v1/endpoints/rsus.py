...
def get(
    ...
    *,
    ...
    rsu_in_db = deps.crud_get(obj_id=rsu_id, crud_model=crud.rsu, detail="RSU [id: {}] not found")
...
def delete(
    ...
    *,
    ...
    deps.crud_get(obj_id=rsu_id, crud_model=crud.rsu, detail="RSU [id: {}] not found")
