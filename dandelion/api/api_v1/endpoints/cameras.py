...
def delete(
    ...
    *,
    ...
    deps.crud_get(db=db, obj_id=camera_id, crud_model=crud.camera, detail="Camera")
...
def get(
    ...
    *,
    ...
    camera_in_db = deps.crud_get(db=db, obj_id=camera_id, crud_model=crud.camera, detail="Camera")
    return camera_in_db.to_dict()
