...
def delete(
    ...
    *,
    ...
    deps.crud_get(obj_id=lidar_id, crud_model=crud.lidar, detail="Lidar [id: {}] not found")
...
def get(
    ...
    *,
    ...
    lidar_in_db = deps.crud_get(
        obj_id=lidar_id, crud_model=crud.lidar, detail="Lidar [id: {}] not found"
    )
    return lidar_in_db.to_dict()
